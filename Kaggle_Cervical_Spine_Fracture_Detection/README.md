...
### 주제(문제)
의사들은 CT와 PET스캔 MRI 그리고 X-ray와 같은 데이터를 이용하여 의학적 상태를 진단하고 치료하는데, 흉부 엑스레이의 해석은 최고의 의사라도 의학적 오진이 있을 수 있다. X-ray에서 보다 정확하게 이상을 식별하고 위치를 파악하는 것은 정확한 진단을 내리는데 도움을 줄 것이다.
