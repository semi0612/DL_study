...
최근 마케팅 기법 중 기존 고객에게 반복 구매를 유도하는 것을 중요시한다는 것을 알게됨.
...
```
  ...
  영수증 데이터를 분석
-> 같은 상품을 반복적으로 구매하는 고객/ 아닌 고객이 나뉨
-> 그 차이가 있을까?
-> 매출액을 확인해보니 반복적으로 구매(재구매)하는 고객의 매출이 상대적으로 높음
-> 그렇다면 반복적인 구매가 적은 (재구매율이 낮은) 고객들의 구매율을 끌어올려야 하지 않을까?]
